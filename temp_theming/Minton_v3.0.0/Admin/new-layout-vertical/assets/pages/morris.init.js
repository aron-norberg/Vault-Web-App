...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createLineChart('morris-line-example', $data, 'y', ['a', 'b','c'], ['Series A', 'Series B', 'Series C'],['0.1'],['#ffffff'],['#999999'], ['#7266ba', '#52bb56', '#ebeff2']);
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b','c'], ['Series A', 'Series B','Series C'], ['#7266ba', '#52bb56', '#bdbdbd']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#7266ba', '#52bb56', '#ebeff2']);
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b'], ['Series A', 'Series B'], ["#039cfd", "#ededed"]);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#7266ba', '#52bb56', '#ebeff2']);
    },
    //init
