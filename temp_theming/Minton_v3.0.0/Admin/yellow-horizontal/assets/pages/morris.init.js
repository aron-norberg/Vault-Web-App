...
!function($) {
    ...
    MorrisCharts.prototype.createLineChart = function(element, data, xkey, ykeys, labels, opacity, Pfillcolor, Pstockcolor, lineColors) {
        ...
        MorrisCharts.prototype.init = function() {
            ...
            this.createLineChart('morris-line-example', $data, 'y', ['a', 'b','c'], ['Series A', 'Series B', 'Series C'],['0.1'],['#ffffff'],['#999999'], ["#f9cd48", "#29b6f6", "#3f51b5"]);
            ...
            this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b','c'], ['Series A', 'Series B','Series C'], ["#f9cd48", "#64b5f6","#dcdcdc"]);
            ...
            this.createDonutChart('morris-donut-example', $donutData, ["#f9cd48", "#ededed", "#64b5f6"]);
        },
        //init
